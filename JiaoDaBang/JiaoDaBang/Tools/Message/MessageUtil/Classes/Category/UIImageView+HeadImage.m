...
//    }
    NSString *profileImage = [MessageUserProfileUtil getavatarURLPathWithUsername:username];
    if (profileImage) {
        [self sd_setImageWithURL:[NSURL URLWithString:profileImage] placeholderImage:placeholderImage];
    }
    else {
        [self sd_setImageWithURL:nil placeholderImage:placeholderImage];
    }
...
//    }
//    
    NSString *nickName = [MessageUserProfileUtil getNickNameWithUsername:username];
    if (nickName) {
