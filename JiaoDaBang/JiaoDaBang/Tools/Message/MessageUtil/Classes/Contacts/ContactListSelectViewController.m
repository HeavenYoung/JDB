...
//    }
    model.nickname = [MessageUserProfileUtil getNickNameWithUsername:model.buddy];
    model.avatarURLPath = [MessageUserProfileUtil getNickNameWithUsername:model.buddy];
    return model;
}
