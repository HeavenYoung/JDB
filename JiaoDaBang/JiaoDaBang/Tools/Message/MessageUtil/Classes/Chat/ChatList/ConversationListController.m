...
//        return [[UserProfileManager sharedInstance] getNickNameWithUsername:self.conversationId];
        return [MessageUserProfileUtil getNickNameWithUsername:self.conversationId];
            ...
            didSelectConversationModel:(id<IConversationModel>)conversationModel
{
    if (conversationModel) {
        ...
        //custome config
        [[MessageUtil shareMessageManage] removeOrderConversationId:conversation.conversationId];        
        if (conversation) {
            if ([[RobotManager sharedInstance] isRobotWithUsername:conversation.conversationId]) {
...
//            }
//            else {
//                model.avatarURLPath = @"http://pic45.nipic.com/20140731/19187786_190840760666_2.jpg";
//            }
            
            model.title = [MessageUserProfileUtil getNickNameWithUsername:conversation.conversationId];
            model.avatarURLPath = [MessageUserProfileUtil getavatarURLPathWithUsername:conversation.conversationId];
...
//    NSString *latestMessageTime = @"";
    NSString *latestMessageTime = [NSDate formattedTimeFromTimeInterval:[[NSDate date] timeIntervalSince1970]];
    EMMessage *lastMessage = [conversationModel.conversation latestMessage];;
    if (lastMessage) {
