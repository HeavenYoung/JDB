...
- (UIImageView*)headImageView
{
    ...
    UserProfileEntity *user = nil;//[[UserProfileManager sharedInstance] getCurUserProfile];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        ...
        UserProfileEntity *entity = nil;//[[UserProfileManager sharedInstance] getCurUserProfile];
