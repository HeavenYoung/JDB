...
- (void)initView {
    ...
    UIView *view1 = [[UIView alloc]initWithFrame:CGRectMake(0, 100, SCREEN_WIDTH, SCREEN_WIDTH)];
    ...
    self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 100,  SCREEN_WIDTH, SCREEN_WIDTH)];
    ...
    [self.showImgView setUserInteractionEnabled:YES];
    [self.showImgView setMultipleTouchEnabled:YES];
    //    [self.showImgView.layer setCornerRadius:self.showImgView.frame.size.width/2.0];
    ...
    [view1 addSubview:self.showImgView];
    ...
    self.ratioView = [[UIView alloc] initWithFrame:CGRectMake(0, 100, SCREEN_WIDTH, SCREEN_WIDTH)];
    ...
    //    [self.ratioView.layer setCornerRadius:self.ratioView.frame.size.width/2.0];
    self.ratioView.autoresizingMask = UIViewAutoresizingNone;
    [self.view addSubview:self.ratioView];
    
    UIImageView *image = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_WIDTH)];
    image.image = [UIImage imageNamed:@"bg_piccrop.png"];
    [view1 addSubview:image];
    
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(75, 40, 250, 30)];
    label.textColor = [UIColor whiteColor];
    label.backgroundColor = [UIColor clearColor];
    label.text = @"移动和缩放";//CustomLocalizedString(@"editusermeans - move and scale", nil);
    label.font = [UIFont systemFontOfSize:26];
    
    CGSize labesize = [self sizeForString:label.text font:label.font constrainedToSize:CGSizeMake(CGFLOAT_MAX,30 )];
    label.frame = CGRectMake((SCREEN_WIDTH - labesize.width)/2, 40, labesize.width, labesize.height);
...
-(UIImage *)getSubImage{
    ...
    UIImageView *theView = [[UIImageView alloc]initWithFrame:squareFrame];
    theView.image = smallImage;
    return [self cutMapView:theView];
    
}
- (UIImage *)cutMapView:(UIImageView *)theView
{
    //************** 得到图片 *******************
    ...
    //*************** 截取小图 ******************
    CGRect rect1 = CGRectMake(SCREEN_WIDTH/8,SCREEN_WIDTH/8, SCREEN_WIDTH/4*3, SCREEN_WIDTH/4*3);//创建矩形框
    //对图片进行截取
    CGImageRef targetImage = CGImageCreateWithImageInRect([image CGImage], rect1);
    UIImage * image2 = [UIImage imageWithCGImage:targetImage];
